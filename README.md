...
## Конфигурирование загрузки шортсов
Изменение параметров загрузки Shorts возможно перед запуском бота в файле `src/params.py`.
По умолчанию загружается лучший звук и лучшее качество до 1080p.
